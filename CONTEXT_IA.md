...
Los IDs de vendedor, cliente y ruta **NO son unicos globalmente**. Son unicos **por sucursal**:
...
1. **No filtrar por anulado**: Las ventas anuladas deben incluirse en los calculos
...
4. **Periodo en cobertura**: Es el primer dia del mes (ej: '2025-01-01' para enero 2025)
5. **facturacion_neta solo en Silver**: Gold fact_ventas no tiene este campo, usar `cantidades_total * subtotal_final` o consultar Silver directamente
