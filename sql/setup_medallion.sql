...
-- Cobertura por Fuerza de Venta/Sucursal/Genérico
...
-- Cobertura por Sucursal/Subdivisión Aguas (solo genérico AGUAS DANONE)
...
-- Usuario nahuel: permisos completos sobre toda la BD
